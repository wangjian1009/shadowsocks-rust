...
use super::super::super::super::platform::udp::Reader;
...
fn test_outbound() {
    ...
    let tests = vec![
        ...
        ("2001:db8::ff00:42:0000", 112, "2001:db8::ff00:42:3242", true),
        ("2001:db8::ff00:42:8000", 113, "2001:db8::ff00:42:0660", false),
        ("2001:db8::ff00:42:8000", 113, "2001:db8::ff00:42:ffff", true),
    ];
...
fn test_bidirectional() {
    ...
    let tests = [
        ...
        (
            ("2001:db8::ff00:42:8000", 113, "2001:db8::ff00:42:ffff", true),
            ("2001:db8::ff40:42:8000", 113, "2001:db8::ff40:42:ffff", true),
        ),
        (
            ("2001:db8::ff00:42:8000", 113, "2001:db8::ff00:42:ffff", true),
            ("2001:db8::ff40:42:8000", 113, "2001:db8::ff40:42:ffff", true),
