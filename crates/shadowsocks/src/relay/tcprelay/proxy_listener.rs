...
impl ProxyListener {
    ...
    pub async fn bind_with_opts(
        ...
        Ok(ProxyListener::from_listener(context, listener, svr_ss_cfg))
    }
    ...
    pub fn from_listener(
        ...
        ProxyListener {
            listener,
            method: svr_ss_cfg.method(),
            key: svr_ss_cfg.key().to_vec().into_boxed_slice(),
            context,
            user_manager: svr_ss_cfg.clone_user_manager(),
        }
    }
