...
mod test {
    ...
    #[test]
    fn tls_success_1() {
        let mut sniffer = SnifferTls::new();
        ...
        assert_eq!(
            Ok(SnifferProtocol::Tls("c.s-microsoft.com".into())),
            sniffer.check(&input)
        );
    }
    ...
    fn tls_success_2() {
        ...
        assert_eq!(
            Ok(SnifferProtocol::Tls("www07.clicktale.net".into())),
            sniffer.check(&input)
        );
    }
    ...
    fn tls_success_3() {
        ...
        assert_eq!(Ok(SnifferProtocol::Tls("dogfish".into())), sniffer.check(&input));
    }
    ...
    fn tls_success_4() {
        ...
        assert_eq!(Ok(SnifferProtocol::Tls("10.42.0.243".into())), sniffer.check(&input));
    }
}
