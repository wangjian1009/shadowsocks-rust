...
const FP_BLOBS: [u8; 20 * FP_BLOB_COUNT] = [
    ...
    102, 88, 30, 153, 54, 72, 147, 121, 14, 71, 201, 4, 130, 210, 159, 182, 24, 221, 128, 48, 112, 231, 122, 2, 3, 195,
    214, 233, 15, 115, 146,
];
...
mod tests {
    ...
    const FP_NOW_GP: [u8; 20] = [
        0xC3, 0x45, 0x15, 0x58, 0x71, 0xDF, 0x1A, 0x47, 0xF7, 0xB7, 0x20, 0xBD, 0xC5, 0xC4, 0x04, 0x11, 0x2E, 0xC8,
        0xB4, 0x55,
    ];
